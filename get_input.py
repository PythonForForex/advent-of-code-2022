...
def get_cookie():
	...
	try:
		...
		db = f'{Path.home()}/.mozilla/firefox/gape0v2q.default-release-1659362209175/cookies.sqlite'
...
def get_input(day=1):
	...
	r = requests.get(f'https://adventofcode.com/2022/day/{day}/input', cookies=cookie_jar)
	r.raise_for_status()
